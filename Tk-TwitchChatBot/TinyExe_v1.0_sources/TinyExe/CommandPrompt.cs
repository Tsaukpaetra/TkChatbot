...
namespace TinyExe
{
    public partial  class CommandPrompt : RichTextBox
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            {
                //Set up the console
                consoleContext = Context.Default;
            }
            //Check if we're not the only Console attached to this context
            if (consoleContext.Console == null)
            {
                consoleContext.Console = this;
            }
        ...
        private void Execute(string expr)
        {
            try
            {
                ...
                Expression exp = new Expression(expr,consoleContext);
